...
async function fetchWantedPersons(searchParams: SearchParams): Promise<ApiResponse> {
...
export async function WantedPersonsList({ searchParams }: { searchParams: SearchParams }) {
